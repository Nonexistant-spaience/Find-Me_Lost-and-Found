      ...
      <div className="sb__footer__section__padding">
        <div className="sb__footer-links">
          ...
          <div className="sb__footer-links_div">
            <h4>Partners</h4>
            <a href="/about">
              <a href="https://kali.org/"> <p>I can change it</p></a>
            </a>
          </div>
          <div className="sb__footer-links_div">
            <h4>Feedback</h4>
          ...
          <div className="sb__footer-links_div">
            ...
            <a href="https://www.instagram.com/nonexistant_sapience/"><p><img src={fb} alt="instaimage"/></p></a>
            <a href="https://twitter.com/nonexistant/"><p><img src={twitter} alt="twitterimage"/></p></a>
            <a href="https://www.facebook.com/nonexistant/"><p><img src={insta} alt="fbimage"/></p></a>
            <a href="https://www.linkedin.com/nonexistant/"><p><img src={linkedin} alt="linkedinimage"/></p></a>
            </div>
          </div>
        </div>
        <hr></hr>
